...
if( NOT VSMARTBODY_FOUND )
	vista_find_package_root( SmartBody core/smartbody/smartbody-lib/src/sb/SBTypes.h )
	if( SMARTBODY_ROOT_DIR )
		set( SMARTBODY_INCLUDE_DIRS 
            ${SMARTBODY_ROOT_DIR}/core/smartbody/smartbody-lib/src/sb/ 
            ${SMARTBODY_ROOT_DIR}/core/smartbody/smartbody-dll/include 
            ${SMARTBODY_ROOT_DIR}/core/smartbody/smartbody-lib/src
        ...
        set( SMARTBODY_LIBRARIES 
            ...
            optimized vhmsg
            optimized wsp
            debug activemq-cppd.lib
            optimized activemq-cpp.lib
            ...
            debug bonebus_d
            debug wspd
            boost_filesystem-vc100-mt-1_51.lib
            glew32.lib
		...
		message( WARNING "vista_find_package_root - File named smartbody-lib/src/sb/SBTypes.h not found" )	
