...
def BuildIt(strBuildType, strCompiler, strCMakeVariables = '', bDeleteCMakeCache = True, strBuildFolder='JenkinsDefault',bRunTests = False):
    
    if sys.platform == 'linux2':
        VistaBuildLinux.BuildIt(strBuildType, strCompiler, strCMakeVariables, bDeleteCMakeCache, strBuildFolder, bRunTests)
        
    elif sys.platform == 'win32':
        VistaBuildWin.BuildIt(strBuildType, strCompiler, strCMakeVariables, bDeleteCMakeCache, strBuildFolder, bRunTests)
