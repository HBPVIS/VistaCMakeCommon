		...
		foreach( _ENTRY ${${_PACKAGE_NAME_UPPER}_MSVC_PROJECT} )
			...
			elseif( _NEXT_IS_PROJ )
				...
				if( EXISTS "${_ENTRY}" )
					...
					list( FIND VISTA_EXTERNALLY_ADDED_PROJECTS "${_NAME}" _PROJ_ALREADY_ADDED )
					if( _PROJ_ALREADY_ADDED EQUAL -1 )
						...
						set( VISTA_EXTERNALLY_ADDED_PROJECTS "${VISTA_EXTERNALLY_ADDED_PROJECTS}" PARENT_SCOPE )
					endif()
