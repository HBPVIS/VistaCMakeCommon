...
macro( vista_find_package_root _PACKAGE_NAME )
	...
	foreach( _ARG ${ARGV} )
		...
		elseif( _NEXT_IS_FOLDER )
			list( APPEND _PACKAGE_FOLDER_NAMES ${_ARGC} )
		elseif( _NEXT_IS_FILE )
			list( APPEND _SEARCH_FILES ${_ARGC} )
	...
	foreach( _FOLDER ${_PACKAGE_FOLDER_NAMES} )
		if( EXISTS "$ENV{${_PACKAGE_NAME_UPPER}_ROOT}" )
			list( APPEND _SEARCH_PATHES_VERSIONED
					$ENV{${_PACKAGE_NAME_UPPER}_ROOT}/${_PACKAGE_NAME}-${_REQUESTED_VERSION}/${VISTA_HWARCH}
					$ENV{${_PACKAGE_NAME_UPPER}_ROOT}/${_PACKAGE_NAME}-${_REQUESTED_VERSION}
		...
		if( EXISTS "$ENV{VRDEV}" )
			list( APPEND _SEARCH_PATHES_VERSIONED
					$ENV{VRDEV}/${_PACKAGE_NAME}/${_PACKAGE_NAME}-${_REQUESTED_VERSION}/${VISTA_HWARCH}
					$ENV{VRDEV}/${_PACKAGE_NAME}/${_PACKAGE_NAME}-${_REQUESTED_VERSION}
					$ENV{VRDEV}/${_PACKAGE_NAME}/${_REQUESTED_VERSION}/${VISTA_HWARCH}
					$ENV{VRDEV}/${_PACKAGE_NAME}/${_REQUESTED_VERSION}
					$ENV{VRDEV}/${_PACKAGE_NAME}-${_REQUESTED_VERSION}/${VISTA_HWARCH}
					$ENV{VRDEV}/${_PACKAGE_NAME}-${_REQUESTED_VERSION}
			)
			list( APPEND _SEARCH_PATHES_UNVERSIONED
					$ENV{VRDEV}/${_PACKAGE_NAME}/current/${VISTA_HWARCH}
					$ENV{VRDEV}/${_PACKAGE_NAME}/current
